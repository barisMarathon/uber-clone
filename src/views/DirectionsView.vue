<template>
  <div id="Directions">
    ...
    <div v-for="address in addressData" :key="address">
      <div @click="storeAddress(address.description)" class="flex items-center custom-border-bottom">
        ...
        <div>
          ...
          <div class="text-lg text-gray-400" v-if="address.terms.length > 2">{{ address.terms[2].value }}</div>
        </div>
      </div>
    </div>
...
<ServiceSelectSmall text="Ride" image="ride" />
